About langchain-anthropic-feedstock
===================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/langchain-anthropic-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/langchain-anthropic-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add langchain-anthropic
# for installing globally
pixi global install langchain-anthropic
```
...
It is possible to list all of the versions of `langchain-anthropic` available on your platform:
...
```
pixi search langchain-anthropic --channel conda-forge
```
